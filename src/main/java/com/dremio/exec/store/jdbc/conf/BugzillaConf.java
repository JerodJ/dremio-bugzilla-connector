...
@SourceType(value = "BugzillaARP", label = "Bugzilla",uiConfig = "bugzilla-layout.json")
public class BugzillaConf extends AbstractArpConf<BugzillaConf> {
  private static final String ARP_FILENAME = "arp/implementation/bugzilla-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.bugzilla.BugzillaDriver";
